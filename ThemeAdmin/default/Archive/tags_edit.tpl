{include file='../tpl/header.tpl' username={$username} id={$id} level={$userlevel} title='标签修改'}
<div class='main'>
	<div class='row'>
		<div class="col-lg-12">
			<h3 class="page-header"><i class="fa fa-pencil-square-o"></i> 标签修改</h3>
			<ol class="breadcrumb">
				<li><i class="fa fa-home"></i><a href="{$smarty.const.ADMIN}">首页</a></li>
				<li><i class="fa fa-pencil-square-o"></i>标签修改</li>	
			</ol>
		</div>
		<div class='col-md-12'>
			...
			<div class='panel panel-default'>
				<div class='panel-body'>
					<div class='form-horizontal'>
						...
						<button id='tag_edit' class='btn btn-danger'>更新</button>
					</div>
				</div>
			</div>
		</div>
