{include file='../tpl/header.tpl' username={$username} id={$id} level={$userlevel} title='撰写文章'}
<div class='main'>
	<div class='row'>
		<div class="col-lg-12">
	...
	<div class='row'>
		...
		<div class='col-md-3'>
			...
			<div class="panel panel-default">
				...
				<div class="panel-body">
					<div class='thumbnail'>
						<img data-root='{$smarty.const.HOME}' src="">
					</div>
						...
						<div class="checkbox">
						    <label>
						    	{section start=1 name='loop' loop=$item['level']}&nbsp;&nbsp;&nbsp;&nbsp;{/section}
						     	<input class='category' data-cate="{$item['term_id']}" type="checkbox">{$item['name']}
						    </label>
						</div>
					{/foreach}
				</div>
