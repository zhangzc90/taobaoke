<?php /* Smarty version Smarty-3.1.6, created on 2017-07-01 15:40:01
         compiled from "D:\wamp64\www\taobaoke\ThemeAdmin\default\tpl\header.tpl" */ ?>
<?php /*%%SmartyHeaderCode:2308593b5bd7b7ae04-42944478%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '93062007ff48726d23dc1438c0581370532155d4' => 
    array (
      0 => 'D:\\wamp64\\www\\taobaoke\\ThemeAdmin\\default\\tpl\\header.tpl',
      1 => 1498894798,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '2308593b5bd7b7ae04-42944478',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.6',
  'unifunc' => 'content_593b5bd852108',
  'variables' => 
  array (
    'title' => 0,
    'username' => 0,
...
<?php if ($_valid && !is_callable('content_593b5bd852108')) {function content_593b5bd852108($_smarty_tpl) {?><!DOCTYPE html>
<html lang="zh-cn">
	<head>
    	<meta charset="utf-8">
...
Option/archive_set.html"><i class="fa fa-gear"></i><span class="text"> 文章设置</span></a></li>
								...
								<li>
									...
									<ul class="nav sub">
										<li><a href="<?php echo @ADMIN;?>
Tao/tao_list.html"><i class="fa fa-database"></i><span class="text"> 已导入商品列表</span></a></li>
										<li><a href="<?php echo @ADMIN;?>
Tao/utao_list.html"><i class="fa fa-puzzle-piece"></i><span class="text"> 自定义商品列表</span></a></li>
										<li><a href="<?php echo @ADMIN;?>
Tao/utao_new.html"><i class="fa fa-plus-circle"></i><span class="text"> 添加自定义商品</span></a></li>
										<li><a href="<?php echo @ADMIN;?>
Tao/tao_new.html"><i class="fa fa-plus-square"></i><span class="text"> 批量添加商品</span></a></li>
										<li><a href="<?php echo @ADMIN;?>
Tao/tao_delete.html"><i class="fa fa-motorcycle"></i><span class="text"> 删除失效商品</span></a></li>
										<li><a href="<?php echo @ADMIN;?>
Tao/tao_delete_list.html"><i class="fa fa-retweet"></i><span class="text"> 商品删除记录</span></a></li>
									</ul>
								</li>
								<li>
									...
									<ul class="nav sub">
										<li><a href="<?php echo @ADMIN;?>
TaoUser/user_list.html"><i class="fa fa-address-card"></i><span class="text"> 用户列表</span></a></li>
										<li><a href="<?php echo @ADMIN;?>
TaoUser/user_new.html"><i class="fa fa-plus-square-o"></i><span class="text"> 用户添加</span></a></li>
									</ul>
								</li>
